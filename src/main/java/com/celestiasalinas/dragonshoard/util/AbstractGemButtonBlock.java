...
import java.util.Random;
    ...
    public abstract class AbstractGemButtonBlock extends HorizontalFaceBlock implements IWaterLoggable {
        public static final BooleanProperty POWERED = BlockStateProperties.POWERED;
        public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

        protected static final VoxelShape CEILING_AABB_X = Block.box(5.0D, 14.0D, 6.0D, 11.0D, 16.0D, 10.0D);
        protected static final VoxelShape CEILING_AABB_Z = Block.box(6.0D, 14.0D, 5.0D, 10.0D, 16.0D, 11.0D);
        protected static final VoxelShape FLOOR_AABB_X = Block.box(5.0D, 0.0D, 6.0D, 11.0D, 2.0D, 10.0D);
        protected static final VoxelShape FLOOR_AABB_Z = Block.box(6.0D, 0.0D, 5.0D, 10.0D, 2.0D, 11.0D);
        protected static final VoxelShape NORTH_AABB = Block.box(6.0D, 5.0D, 14.0D, 10.0D, 11.0D, 16.0D);
        protected static final VoxelShape SOUTH_AABB = Block.box(6.0D, 5.0D, 0.0D, 10.0D, 11.0D, 2.0D);
        protected static final VoxelShape WEST_AABB = Block.box(14.0D, 5.0D, 6.0D, 16.0D, 11.0D, 10.0D);
        protected static final VoxelShape EAST_AABB = Block.box(0.0D, 5.0D, 6.0D, 2.0D, 11.0D, 10.0D);
        protected static final VoxelShape PRESSED_CEILING_AABB_X = Block.box(5.0D, 15.0D, 6.0D, 11.0D, 16.0D, 10.0D);
        protected static final VoxelShape PRESSED_CEILING_AABB_Z = Block.box(6.0D, 15.0D, 5.0D, 10.0D, 16.0D, 11.0D);
        protected static final VoxelShape PRESSED_FLOOR_AABB_X = Block.box(5.0D, 0.0D, 6.0D, 11.0D, 1.0D, 10.0D);
        protected static final VoxelShape PRESSED_FLOOR_AABB_Z = Block.box(6.0D, 0.0D, 5.0D, 10.0D, 1.0D, 11.0D);
        protected static final VoxelShape PRESSED_NORTH_AABB = Block.box(6.0D, 5.0D, 15.0D, 10.0D, 11.0D, 16.0D);
        protected static final VoxelShape PRESSED_SOUTH_AABB = Block.box(6.0D, 5.0D, 0.0D, 10.0D, 11.0D, 1.0D);
        protected static final VoxelShape PRESSED_WEST_AABB = Block.box(15.0D, 5.0D, 6.0D, 16.0D, 11.0D, 10.0D);
        protected static final VoxelShape PRESSED_EAST_AABB = Block.box(0.0D, 5.0D, 6.0D, 1.0D, 11.0D, 10.0D);
        private final boolean sensitive;

        protected AbstractGemButtonBlock(boolean p_i48436_1_, AbstractBlock.Properties p_i48436_2_) {
            super(p_i48436_2_);
            this.registerDefaultState(this.stateDefinition.any().setValue(FACING, Direction.NORTH).setValue(POWERED, Boolean.valueOf(false)).setValue(FACE, AttachFace.WALL).setValue(WATERLOGGED, Boolean.valueOf(false)));
        ...
        protected void createBlockStateDefinition(StateContainer.Builder<Block, BlockState> p_206840_1_) {
            p_206840_1_.add(FACING, POWERED, FACE, WATERLOGGED);
        }
