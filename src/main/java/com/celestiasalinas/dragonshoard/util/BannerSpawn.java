...
//essentially a new 'egg' class, or an attempt at one? Little clue what I'm doing

public class BannerSpawn extends Item {
    private static final Map<EntityType<?>, BannerSpawn> BY_ID = Maps.newIdentityHashMap();
    private final int color1;
    private final int color2;
    private final EntityType<?> defaultType;

    public BannerSpawn(EntityType<?> p_i48465_1_, int p_i48465_2_, int p_i48465_3_, Item.Properties p_i48465_4_) {
        super(p_i48465_4_);
    ...
    @Nullable
    @OnlyIn(Dist.CLIENT)
    public static BannerSpawn byId(@Nullable EntityType<?> p_200889_0_) {
        return BY_ID.get(p_200889_0_);
    }

    public static Iterable<BannerSpawn> eggs() {
