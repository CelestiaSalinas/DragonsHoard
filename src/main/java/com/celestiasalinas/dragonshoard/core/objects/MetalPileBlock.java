...
public class MetalPileBlock extends Block implements IWaterLoggable {
    ...
    public MetalPileBlock(AbstractBlock.Properties p_i48328_1_) {
        super(p_i48328_1_);
    ...
    public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
        ...
        if (blockstate.is(this)) {
            ...
            return this.defaultBlockState().setValue(WATERLOGGED, Boolean.valueOf(iWorld.getFluidState(blockpos).getType() == Fluids.WATER));
        }
        }
    ...
    protected void createBlockStateDefinition(StateContainer.Builder<Block, BlockState> p_206840_1_) {
        p_206840_1_.add(WATERLOGGED, LAYERS);
    }
}