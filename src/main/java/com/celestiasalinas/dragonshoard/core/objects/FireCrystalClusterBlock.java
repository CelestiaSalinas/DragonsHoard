...
public class FireCrystalClusterBlock extends CrystalBlock implements IWaterLoggable {
    ...
    public FireCrystalClusterBlock(int p_152015_, int p_152016_, Properties p_152017_) {
        super(p_152017_);
    ...
    public void animateTick(BlockState p_180655_1_, World worldIn, BlockPos p_180655_3_, Random rand) {
        ...
        if (rand.nextInt(5) == 0) {
            worldIn.addParticle(ParticleTypes.DRIPPING_LAVA, d0 + (double)direction.getStepX() * d3, d1 + (double)direction.getStepY() * d3, d2 + (double)direction.getStepZ() * d3, rand.nextGaussian() * 0.005D, rand.nextGaussian() * 0.005D, rand.nextGaussian() * 0.005D);
        }
