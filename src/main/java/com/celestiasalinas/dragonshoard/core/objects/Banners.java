...
public class Banners extends PaintingType {
    public Banners(int width, int height) {
        super(width, height);
    }
...
//
//    public Banners(EntityType<? extends PaintingEntity> p_i50221_1_, World p_i50221_2_) {
//        super(p_i50221_1_, p_i50221_2_);
//    }
//
//    public Banners(World p_i45849_1_, BlockPos p_i45849_2_, Direction p_i45849_3_) {
//        super(EntityType.PAINTING, p_i45849_1_, p_i45849_2_);
//        List<PaintingType> list = Lists.newArrayList();
//        int i = 0;
//
//        for(PaintingType paintingtype : net.minecraft.util.registry.Registry.MOTIVE) {
...
//
//    @OnlyIn(Dist.CLIENT)
//    public Banners(World p_i48559_1_, BlockPos p_i48559_2_, Direction p_i48559_3_, PaintingType p_i48559_4_) {
...
//        p_213281_1_.putString("Motive", net.minecraft.util.registry.Registry.MOTIVE.getKey(this.motive).toString());
