...
public class WaterCrystalClusterBlock extends CrystalBlock implements IWaterLoggable {
    ...
    public WaterCrystalClusterBlock(int p_152015_, int p_152016_, Properties p_152017_) {
        super(p_152017_);
    ...
    public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        ...
        if (rand.nextInt(5) == 0) {
            worldIn.addParticle(ParticleTypes.BUBBLE, d0 + (double)direction.getStepX() * d3, d1 + (double)direction.getStepY() * d3, d2 + (double)direction.getStepZ() * d3, rand.nextGaussian() * 0.005D, rand.nextGaussian() * 0.005D, rand.nextGaussian() * 0.005D);
        }
        if (rand.nextInt(5) == 0) {
            worldIn.addParticle(ParticleRegistry.BLUE_GLITTER.get(), d0 + (double)direction.getStepX() * d3, d1 + (double)direction.getStepY() * d3, d2 + (double)direction.getStepZ() * d3, rand.nextGaussian() * 0.005D, rand.nextGaussian() * 0.005D, rand.nextGaussian() * 0.005D);
        }
