...
public class BannersEntity extends HangingEntity {
    ...
    public BannersEntity(World p_i45849_1_, BlockPos p_i45849_2_, Direction p_i45849_3_) {
        super(EntityType.PAINTING, p_i45849_1_, p_i45849_2_);
        List<Banners> list = Lists.newArrayList();
        int i = 0;
        ...
        if (!list.isEmpty()) {
            Iterator<Banners> iterator = list.iterator();

            while(iterator.hasNext()) {
                Banners paintingtype1 = iterator.next();
