...
public class LightningCrystalClusterBlock extends CrystalBlock implements IWaterLoggable {
    ...
    public LightningCrystalClusterBlock(int p_152015_, int p_152016_, AbstractBlock.Properties p_152017_) {
        super(p_152017_);
    ...
    public void animateTick(BlockState p_180655_1_, World p_180655_2_, BlockPos p_180655_3_, Random p_180655_4_) {
        ...
        if (p_180655_4_.nextInt(5) == 0) {
            p_180655_2_.addParticle(ParticleRegistry.PURPLE_GLITTER.get(), d0 + (double)direction.getStepX() * d3, d1 + (double)direction.getStepY() * d3, d2 + (double)direction.getStepZ() * d3, p_180655_4_.nextGaussian() * 0.005D, p_180655_4_.nextGaussian() * 0.005D, p_180655_4_.nextGaussian() * 0.005D);
        }
