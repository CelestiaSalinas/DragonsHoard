...
@OnlyIn(Dist.CLIENT)
public class Bubbles extends SimpleAnimatedParticle {
    private Bubbles(ClientWorld p_i232382_1_, double p_i232382_2_, double p_i232382_4_, double p_i232382_6_, double p_i232382_8_, double p_i232382_10_, double p_i232382_12_, IAnimatedSprite p_i232382_14_) {
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            return new Bubbles(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, p_199234_9_, p_199234_11_, p_199234_13_, this.sprites);
        }
    }
}