...
@OnlyIn(Dist.CLIENT)
public class Drippy extends SpriteTexturedParticle {
    private final Fluid type;
    protected boolean isGlowing;

    private Drippy(ClientWorld p_i232361_1_, double p_i232361_2_, double p_i232361_4_, double p_i232361_6_, Fluid p_i232361_8_) {
    ...
    @OnlyIn(Dist.CLIENT)
    static class Dripping extends Drippy {
    ...
    public static class DrippingHoneyFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy.Dripping dripparticle$dripping = new Drippy.Dripping(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.EMPTY, ParticleTypes.FALLING_HONEY);
    ...
    @OnlyIn(Dist.CLIENT)
    static class DrippingLava extends Drippy.Dripping {
    ...
    public static class DrippingLavaFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy.DrippingLava dripparticle$drippinglava = new Drippy.DrippingLava(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.LAVA, ParticleTypes.FALLING_LAVA);
    ...
    public static class DrippingObsidianTearFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy.Dripping dripparticle$dripping = new Drippy.Dripping(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.EMPTY, ParticleTypes.FALLING_OBSIDIAN_TEAR);
    ...
    public static class DrippingWaterFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy dripparticle = new Drippy.Dripping(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.WATER, ParticleTypes.FALLING_WATER);
    ...
    public static class FallingHoneyFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy dripparticle = new Drippy.FallingHoneyParticle(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.EMPTY, ParticleTypes.LANDING_HONEY);
    ...
    @OnlyIn(Dist.CLIENT)
    static class FallingHoneyParticle extends Drippy.FallingLiquidParticle {
    ...
    public static class FallingLavaFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy dripparticle = new Drippy.FallingLiquidParticle(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.LAVA, ParticleTypes.LANDING_LAVA);
    ...
    @OnlyIn(Dist.CLIENT)
    static class FallingLiquidParticle extends Drippy.FallingNectarParticle {
    ...
    public static class FallingNectarFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy dripparticle = new Drippy.FallingNectarParticle(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.EMPTY);
    ...
    @OnlyIn(Dist.CLIENT)
    static class FallingNectarParticle extends Drippy {
    ...
    public static class FallingObsidianTearFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy dripparticle = new Drippy.FallingLiquidParticle(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.EMPTY, ParticleTypes.LANDING_OBSIDIAN_TEAR);
    ...
    public static class FallingWaterFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy dripparticle = new Drippy.FallingLiquidParticle(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.WATER, ParticleTypes.SPLASH);
            dripparticle.setColor(0.2F, 0.3F, 1.0F);
            dripparticle.pickSprite(this.sprite);
            return dripparticle;
        }
    ...
    @OnlyIn(Dist.CLIENT)
    static class Landing extends Drippy {
    ...
    public static class LandingHoneyFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy dripparticle = new Drippy.Landing(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.EMPTY);
    ...
    public static class LandingLavaFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            Drippy dripparticle = new Drippy.Landing(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.LAVA);
            dripparticle.setColor(1.0F, 0.2857143F, 0.083333336F);
            dripparticle.pickSprite(this.sprite);
            return dripparticle;
        }
